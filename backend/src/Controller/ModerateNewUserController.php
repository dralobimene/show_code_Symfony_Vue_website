<?php
// fichier: src/Controller/ModerateNewUserController
// vue associée: src/views/view15_adm_moderate_new_user.vue
...
/*
 * fichier: src/Controller/ModerateNewUserController.php
 * vue associée: src/views/view15_adm_moderate_new_user.vue
 */
#[Route('/adm')]
class ModerateNewUserController extends AbstractController
{
    #[Route('/moderate_new_user', name: 'app_moderate_new_user')]
