<?php
// fichier controller: src/Controller/ModerateNewSpecificReplyController {filId}
...
/*
 * fichier: src/Controller/ModerateNewSpecifiReplyController.php {filId}
 * vue associée: src/views/view122_adm_moderate_new_specific_reply.vue
 */
#[Route('/adm')]
class ModerateNewSpecificReplyController extends AbstractController
{
    #[Route('/moderate_new_specific_reply/{filId}',
    name: 'app_moderate_new_specific_reply')]
    public function index(Request $request,
                          JWTService $jwt,
                          DocumentManager $dm,
                          string $filId): JsonResponse
    {
