<?php
// fichier: src/Controller/ModerateNewCommentsController
// vue associée: src/views/view18_adm_moderate_new_comments.vue
...
/*
 * fichier: src/Controller/ModerateNewCommentsController.php
 * vue associée: src/views/view18_adm_moderate_new_comments.vue
 */
#[Route('/adm')]
class ModerateNewCommentsController extends AbstractController
{
    #[Route('/moderate_new_comments', name: 'app_moderate_new_comments')]
