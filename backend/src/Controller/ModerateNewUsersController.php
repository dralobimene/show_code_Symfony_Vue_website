<?php
// fichier: src/Controller/ModerateNewUsersController
// vue associée: src/views/view19_adm_moderate_new_users.vue
...
/*
 * fichier: src/Controller/ModerateNewUsersController.php
 * vue associée: src/views/view19_adm_moderate_new_users.vue
 */
#[Route('/adm')]
class ModerateNewUsersController extends AbstractController
{
    #[Route('/moderate_new_users', name: 'app_moderate_new_users')]
