...
class Entree:
    ...
    def __init__(self,
        ...
        self.__surface = pygame.Surface((Entree.TILE_SIZE, Entree.TILE_SIZE), pygame.SRCALPHA)
        self.__surface.fill(Entree.BLUE)
    ...
    def __str__(self):
        return f"Entree: position={self.__position}"
